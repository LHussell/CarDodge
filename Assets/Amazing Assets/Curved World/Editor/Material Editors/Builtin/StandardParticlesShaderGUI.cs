...
namespace AmazingAssets.CurvedWorldEditor
{
    internal class StandardParticlesShaderGUI : ShaderGUI
    {
        ...
        private static class Styles
        {
            ...
            public static GUIContent flipbookBlending = new GUIContent("Flip-Book Frame Blending", "Enables blending between the frames of animated texture sheets.");
            ...
            public static GUIContent distortionEnabled = new GUIContent("Distortion", "Use a grab pass and normal map to simulate refraction.");
            ...
            public static GUIContent softParticlesEnabled = new GUIContent("Soft Particles", "Fade out particle geometry when it gets close to the surface of objects written into the depth buffer.");
            ...
            public static GUIContent cameraFadingEnabled = new GUIContent("Camera Fading", "Fade out particle geometry when it gets close to the camera.");
            ...
            public static GUIContent blendingOptionsText = new GUIContent("Blending Options");
            public static GUIContent mainOptionsText = new GUIContent("Main Options");
            public static GUIContent mapsOptionsText = new GUIContent("Maps");
            public static GUIContent requiredVertexStreamsText = new GUIContent("Required Vertex Streams");

            public static GUIContent streamPositionText = new GUIContent("Position (POSITION.xyz)");
            public static GUIContent streamNormalText = new GUIContent("Normal (NORMAL.xyz)");
            public static GUIContent streamColorText = new GUIContent("Color (COLOR.xyzw)");
            public static GUIContent streamColorInstancedText = new GUIContent("Color (INSTANCED0.xyzw)");
            public static GUIContent streamUVText = new GUIContent("UV (TEXCOORD0.xy)");
            public static GUIContent streamUV2Text = new GUIContent("UV2 (TEXCOORD0.zw)");
            public static GUIContent streamAnimBlendText = new GUIContent("AnimBlend (TEXCOORD1.x)");
            public static GUIContent streamAnimFrameText = new GUIContent("AnimFrame (INSTANCED1.x)");
            public static GUIContent streamTangentText = new GUIContent("Tangent (TANGENT.xyzw)");
        ...
        void DoVertexStreamsArea(Material material)
        {
            ...
            bool useGPUInstancing = true;// ShaderUtil.HasProceduralInstancing(material.shader);
